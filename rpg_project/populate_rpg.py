...
def populate():
    ...
    add_monster('Ricky Wayne','monster_images/RickyWayne.jpg','10','31','False','50','9', Area.objects.get(name='Suburb'))
    add_monster('Nannerpuss','monster_images/nannerpuss.jpg','6','9','False','20','4', Area.objects.get(name='Sea'))
    add_monster('Slug','monster_images/slug.jpg','7','9','False','26','5', Area.objects.get(name='Tundra'))
    ...
    add_monster('Godzilla','monster_images/Godzilla.jpg','9','9','False','30','2',Area.objects.get(name='Ruins'))

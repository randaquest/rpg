...
def populate():
    ...
    add_area('Ruins','area_images/Ruins.jpg','8','Oh no everybody is dead.')
    add_monster('LaserCat','monster_images/cat.jpg','7','20','False','17','10', Area.objects.get(name='Cat Island'))
    add_monster('Dodo','monster_images/dodo.jpg','3','10','False','11','3', Area.objects.get(name='Mountains'))
    add_monster('Salad Fingers','monster_images/saladfingers.jpg','6','5','False','3','4', Area.objects.get(name='City'))
    add_monster('Charlie the Unicorn','monster_images/charlie.jpg','5','16','False','13','5', Area.objects.get(name='Closet'))
    add_monster('Marcel the Shell with Shoes On','monster_images/marcel.jpg','10','35','False','25','9', Area.objects.get(name='Forest'))
    add_monster('Shark','monster_images/shark.jpg','2','18','False','16','9', Area.objects.get(name='Space'))
    add_monster('Nerd','monster_images/nerd.jpg','1','3','False','3','5', Area.objects.get(name='Desert'))
    add_monster('Ricky Wayne','monster_images/RickyWayne.jpg','10','38','False','30','12', Area.objects.get(name='Suburb'))
    add_monster('Nannerpuss','monster_images/nannerpuss.jpg','6','9','False','10','4', Area.objects.get(name='Sea'))
    add_monster('Slug','monster_images/slug.jpg','7','14','False','13','7', Area.objects.get(name='Tundra'))
    add_monster('Snowman','monster_images/Snowman.jpg','2','3','False','8','3', Area.objects.get(name='Cave'))
    add_monster('Kraken','monster_images/kraken.jpg','4','9','False','9','5',Area.objects.get(name='Beach'))
    add_monster('Godzilla','monster_images/Godzilla.jpg','9','12','False','15','2',Area.objects.get(name='Ruins'))
    add_monster('Bruce Jenner','monster_images/Bruce.jpg','1','2','False','7','2', Area.objects.get(name='Desert'))
    add_monster('Monkey','monster_images/Monkey.jpg','4','6','False','3','5', Area.objects.get(name='Closet'))
    add_monster('Spider-Dog','monster_images/SpiderDog.jpg','7','12','False','10','6', Area.objects.get(name='Cat Island'))
    add_monster('Snake','monster_images/Snake.jpg','8','9','False','12','7', Area.objects.get(name='Space'))
    add_monster('Fat Lady','monster_images/FatLadie.jpg','2','8','False','3','4', Area.objects.get(name='Sea'))
    add_monster('Puppet','monster_images/puppet.jpg','8','12','False','13','6',Area.objects.get(name='City'))

...
def populate():
    ...
    add_location('Barbarica DC','area_images/barbarian.jpg','5','You can smell the stench emanating from the city for miles, the brutal capital of the Barbarians is not for the weak of scent. Legend says that their ruler has not bathed for millenna','45','32',True)    assign()

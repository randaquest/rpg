...
def populate():
    ...
    add_monster('LaserCat','monster_images/cat.jpg','7','20','False','34','10', Area.objects.get(name='Cat Island'))
    add_monster('Dodo','monster_images/dodo.jpg','3','10','False','21','3', Area.objects.get(name='Mountains'))
    add_monster('Salad Fingers','monster_images/saladfingers.jpg','6','5','False','6','4', Area.objects.get(name='City'))
    add_monster('Charlie the Unicorn','monster_images/charlie.jpg','5','16','False','26','5', Area.objects.get(name='Closet'))
    add_monster('Marcel the Shell with Shoes On','monster_images/marcel.jpg','10','35','False','50','9', Area.objects.get(name='Forest'))
    add_monster('Shark','monster_images/shark.jpg','2','18','False','32','9', Area.objects.get(name='Space'))
    add_monster('Nerd','monster_images/nerd.jpg','1','3','False','6','5', Area.objects.get(name='Desert'))
    add_monster('Ricky Wayne','monster_images/RickyWayne.jpg','10','38','False','50','12', Area.objects.get(name='Suburb'))
    add_monster('Nannerpuss','monster_images/nannerpuss.jpg','6','9','False','20','4', Area.objects.get(name='Sea'))
    add_monster('Slug','monster_images/slug.jpg','7','14','False','26','7', Area.objects.get(name='Tundra'))
    ...
    add_monster('Godzilla','monster_images/Godzilla.jpg','9','12','False','30','2',Area.objects.get(name='Ruins'))
    ...
    add_monster('Spider-Dog','monster_images/SpiderDog.jpg','7','12','False','20','6', Area.objects.get(name='Cat Island'))
    add_monster('Snake','monster_images/Snake.jpg','8','9','False','24','7', Area.objects.get(name='Space'))
    add_monster('Fat Lady','monster_images/FatLady.jpg','2','8','False','6','4', Area.objects.get(name='Sea'))
    add_monster('Puppet','monster_images/puppet.jpg','8','12','False','26','6',Area.objects.get(name='City'))
